...
var filter = m => m.author.id === message.author.id;
      ...
      message.channel.send(`<a:tada:797757216929087499>| **Çekilişin yapılacağı kanalın adını yaz**`).then(msg => {
            ...
            msg.edit('<a:r_evet:785437821926113290> **Şimdi de ödülü yaz bakalım**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setFooter(message.author.username + " İmparatorBot Çekiliş Sistemi", message.author.avatarURL);
                  message.guild.channels.cache.find(x => x.name ===  room).send(' <a:r_evet:785437821926113290> **ÇEKİLİŞ BAŞLADI** <a:r_evet:785437821926113290>' , {embed: giveEmbed}).then(m => {
                     ...
                     setTimeout(() => {
                       ...
                       .setTitle(title)
                       .setColor("#f558c9")
            .setFooter("İmparatorBot çekiliş sistemi")
