...
exports.run = async (client, message, args) => {  
 ...
 let modlogs = db.get(`modlogkanaly_${message.guild.id}`)
  ...
  if(!modlogs) {
    ...
    if(!kanal) return message.reply(`<a:XTik:798277028050501642> **Lütfen bir kanal giriniz!** \n> **Doğru Kullanım;** \`${prefix}mod-log <#kanal>\``)
    ...
    const modlogkanal = message.guild.channels.cache.find(kanal => kanal.id === modlogs);
      ...
      .setColor("RANDOM")
      .setDescription(`<a:tik1:798276995011051530> **Modlog kanalı başarılı bir şekilde ayarlandı.**`)
      ...
      .setColor("RANDOM")
      .setDescription(`<a:XTik:798277028050501642> **Bu sunucuda daha önceden modlog kanalı ayarlanmış. Sıfırlamak için:** \`${prefix}mod-log-sıfırla\`\n**Ayarlanan kanal:** \`${modlogkanal.name}\``)
