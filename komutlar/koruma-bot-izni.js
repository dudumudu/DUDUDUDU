...
exports.run = (client, message, args) => {
  ...
  new Discord.MessageEmbed()
  .setDescription("<a:XTik:798277028050501642> Lütfen bir bot id si girin."));

  if (isNaN(args[1])) {
    return message.channel.sed(
      new Discord.MessageEmbed()
      .setColor("#501c67")
      .setDescription("<a:XTik:798277028050501642> Sadece bot id'si girin."));
  }
  if (args[0] == "ver") {
    ...
    .setColor("#501c67")
    .setDescription("<a:tik1:798276995011051530>" + args[1] + "ID li bota izin verildi.")
