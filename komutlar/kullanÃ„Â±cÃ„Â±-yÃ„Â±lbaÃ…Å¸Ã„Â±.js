...
return message.channel.send(
   ...
   .setColor("#ff4400") 
   .setDescription(`<a:tadaaa:797757216929087499> **Yılbaşının kutlanmasına Dair Bilgiler Aşağıda;** \n\n> Gün: **${zaman.days}** \n> Saat: **${zaman.hours}** \n> Dakika: **${zaman.minutes}** \n\n <a:tik1:798276995011051530> **Yılbaşının kutlanmasına Bu Kadar Zaman Kaldı!**`)
)
};
